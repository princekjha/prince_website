    ...
    <div className="space-y-8">
      ...
      {isEditing ? (
        <form onSubmit={handleSave} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-xl space-y-6 max-w-4xl">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Featured Image Path (e.g. /images/blog/photo.png)</label>
            <input 
              className="w-full px-4 py-3 rounded-xl bg-gray-50 border-2 border-transparent focus:bg-white focus:border-[#E67E22] focus:outline-none"
              value={currentPost?.featuredImage}
              onChange={e => setCurrentPost({ ...currentPost, featuredImage: e.target.value })}
              placeholder="/images/blog/article1.png"
            />
          </div>
