    ...
    <div className="space-y-8">
      ...
      {isEditingTopic ? (
        <form onSubmit={handleSaveTopic} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-xl space-y-6 max-w-2xl">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Icon Path (e.g. /images/topics/python.svg)</label>
            <input className="w-full px-4 py-3 rounded-xl bg-gray-50 border-2 border-transparent focus:bg-white focus:border-[#E67E22] outline-none" value={currentTopic?.icon} onChange={e => setCurrentTopic({...currentTopic, icon: e.target.value})} placeholder="/images/topics/default.png" />
          </div>
