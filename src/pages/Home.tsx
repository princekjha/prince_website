        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-text-primary leading-tight whitespace-nowrap">
            ...
            {/* Specialized Skills - Tabbed Interface Like Academic Core */}
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              ...
              <div className="bg-bg-secondary rounded-3xl border border-border-theme shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[400px]">
                ...
                <div className="w-full md:w-56 bg-bg-primary/50 border-r border-border-theme p-4 space-y-2">
                  <div className="px-5 py-2 mb-2">
                     <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Domain</span>
                  </div>
                  {(data.skills || []).map((cat) => (
                    <button
                      key={cat.category}
                    ...
                    : 'text-text-secondary/40 hover:bg-bg-secondary/50 hover:text-text-secondary'
                  )}
                    >
                ...
                <div className="flex-1 p-6 md:p-8">
                  <div className="overflow-hidden">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="text-[10px] font-bold uppercase tracking-[0.2em] text-text-secondary/40 border-b border-border-theme">
                      ...
                      <tbody className="divide-y divide-border-theme/50">
                        {(data.skills?.find(c => c.category === activeCategory)?.skills || []).map((s: any, sIdx: number) => (
                          <tr key={sIdx} className="group hover:bg-bg-primary/30 transition-colors">
                            ...
                            <td className="py-4 text-[11px] text-text-secondary/40 font-story italic text-right pr-4">
                              {s.subSkills}
                            </td>
                          </tr>
                        ))}
          ...
          <div className="lg:col-span-4 relative group">
            ...
            >
              ...
              {isAdmin && (
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center p-6 text-center text-white text-white">
